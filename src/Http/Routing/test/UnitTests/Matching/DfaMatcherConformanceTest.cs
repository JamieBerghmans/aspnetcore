...
namespace Microsoft.AspNetCore.Routing.Matching
{
    public class DfaMatcherConformanceTest : FullFeaturedMatcherConformanceTest
    {
        ...
        public virtual async Task Match_Regression_1867_CorrectBehavior(string path, int endpointIndex)
        {
        ...
        [InlineData("/middleware/test1/test2", -1)]
        [InlineData("/bill/boga", 0)]
        public virtual async Task Match_Regression_1867_DefaultBehavior(string path, int endpointIndex)
        {
            var endpoints = new RouteEndpoint[]
            {
                EndpointFactory.CreateRouteEndpoint(
        ...
        [InlineData("/middleware/test1/test2", -1)]
        [InlineData("/bill/boga", 0)]
        public virtual async Task Match_Regression_1867_LegacyBehavior(string path, int endpointIndex)
        {
            var endpoints = new RouteEndpoint[]
            {
                EndpointFactory.CreateRouteEndpoint(
